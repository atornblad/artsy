var b=!0,n=null,u=!1,aa=Math.random,ba=0,ca=1;function da(a,c,d){return"rgba("+(a|0)+","+(c|0)+","+(d|0)+",1)"}var x;a:{for(var ea=["requestAnimationFrame","mozRequestAnimationFrame","webkitRequestAnimationFrame"],fa=0;fa<ea.length;++fa){var ga=ea[fa];if(window[ga]){x=window[ga];break a}}x=function(a){var c=(new Date).getTime(),c=c-c%17+17-c;5>c&&(c=17);window.setTimeout(function(){a.call(window,(new Date).getTime())},c)}}var ia=4*Math.atan(1),ja=Math.max(320,256);
function y(a){return(1-Math.cos(a*ia))/2}
for(var ka,A,B,la,ma,na,C,oa=0,pa,F,qa,G,H,I,ra=0,sa=0,J=0,ta=10,K=1050,ua=9,va=9,wa=32768,xa=[{p:255,n:255,k:255},{p:255,n:64,k:128},{p:255,n:255,k:255},{p:96,n:240,k:255}],ya,N,O,za,P,Aa,Ba,Da,Ea,Fa,Ga,Q,Ha,Ia,Ja,Ka,La,Ma,Na,Oa,Pa,Qa,R=[],Ra=[{b:31,c:0,d:481,e:0},{b:481,c:0,d:440,e:460},{b:440,c:460,d:256,e:511},{b:256,c:511,d:71,e:460},{b:71,c:460,d:31,e:0},{b:256,c:37,d:440,e:37},{b:440,c:37,d:405,e:431},{b:405,c:431,d:256,e:472},{b:256,c:472,d:256,e:413},{b:256,c:355,d:256,e:264},{b:256,c:208,
...
0;65536>=k;k+=256){var r=320*(1+0.3*B[10*k%65536]),p=w+100/q*r*B[(k+J)%65536],r=g+100/q*r*B[(k+16384+J)%65536];k?A.lineTo(p,r):A.moveTo(p,r)}for(k=65536;0<=k;k-=4096)r=320,p=w+100/q*r*B[(k+J)%65536],r=g+100/q*r*B[(k+16384+J)%65536],A.lineTo(p,r);A.closePath();A.fillStyle="rgba("+(s.p*m+36*(1-m)).toFixed(0)+","+(s.n*m).toFixed(0)+","+(s.k*m).toFixed(0)+",1)";A.fill()}for(d=sa-9*e;0>d;)++ra,d+=100,2<=a&&0<ta&&--ta,1<=a&&0<ua&&--ua,3==a&&c>16E3-1E3*(1050/9)/60&&--va;sa=d|0;J=J+65536-473*e&65535;3==a&&
...
k+=120;d=[];for(var p=-96;96>=p;++p)if(0!=p){var t=(h*Math.abs(p)/96+h)/2,z=p/50,D=p+2*(p-0),v=(288-D)/(z-t),E=0>v;E&&(v=(-288-D)/(z-t));z=E?Ga:Fa;t=(v- -150)/150;if(E&&v>k&&500>v&&(!q||v<j)&&0<r)d.push({u:p,r:-160/t-v*f,t:160/t-v*f,height:100/t,alpha:1-v/500}),k+=120,--r;E=u;if(q&&v>j)p<m&&(m=p),p>g&&(g=p,s=-160/t-j*f,w=160/t-j*f);else if(500>v)var ha=v+c/2,L=256*(1-v/500)&511,M=v*f,v=ha/O/4&255,E=0<=v?z[v]:u,ha=ha%O&255;v=-160/t-M;z=160/t-M;for(D=-160;160>D;++D){if(D<v||D>z||E===u||void 0===E)a[l++]=
a[l++]=a[l++]=0;else{var Ca=4*(ha*N+(((D+M)*t+160>>1)%20&4095)+E);a[l++]=e[Ca++]*L>>8;a[l++]=e[Ca++]*L>>8;a[l++]=e[Ca++]*L>>8}a[l++]=255}}Aa.putImageData(Ba,0,0);A.drawImage(P,0,64,640,384);q&&(A.globalAlpha=1-j/500,A.drawImage(Da,2*s+320,2*m+256,2*(w-s),2*(g-m)));for(s=d.length;c=d[--s];)w=2*c.r+320,L=2*(c.t-c.r),M=2*c.u+256,a=c.height,A.globalAlpha=1,A.fillStyle="#000000",A.fillRect(w,M,L,a),A.globalAlpha=c.alpha,A.drawImage(Ea,w,M,L,a)},function(a,c,d){var e=19*c+1E4;A.fillStyle="#441010";A.fillRect(0,
...
q}Ha.clearRect(0,0,224,224);Ha.putImageData(Ia,0,0);A.drawImage(Q,96,32,448,448);512>c&&(A.fillStyle="#441000",A.fillRect(0,0,640,256-c/2),A.fillRect(0,256+c/2,640,256-c/2));0.95<d&&(A.fillStyle="rgba(0,0,0,"+(20*d-19).toFixed(3)+")",A.fillRect(0,0,640,512))},function(a,c,d){A.fillStyle="#000000";A.fillRect(0,0,640,512);a=R[a];var e=a.o,l=e.width*a.scale,f=e.height*a.scale;A.drawImage(e,320-(l>>1),256-(f>>1),l,f);500>c?(A.globalAlpha=1-c/500,A.fillStyle=a.l,A.fillRect(0,0,640,512)):(c=c/d-c,500>c&&
(A.globalAlpha=1-c/500,A.fillStyle=a.m,A.fillRect(0,0,640,512)))},function(a,c,d){var e=1;0.95<d&&(e=20*(1-d));A.fillStyle="#000000";A.fillRect(0,0,640,512);var l,f,h,j,q,m;switch(a){case 0:l=Sa;f=h=j=0;q=1024-2048*d;m=c/4;break;case 1:l=Ya,q=0,m=c/4,f=0,6E3<c?f=1:2E3<c&&(f=y((c-2E3)/4E3)),j=-c/10+2048*f*B[5*c+3E4&65535],h=1024*f*B[2*c+54E3&65535],f=18E3<c?1:14E3<c?y((c-14E3)/4E3):0,f=3072*f*B[3*(c-14E3)&65535]}m>l.length&&(m=l.length);A.fillStyle="#ffffff";for(a=0;a<m;++a){var g=l[a],s=$a(g.x+f);
d=$a(g.y+h);g=$a(g.s+j);g+=q;if(-1E3<g&&1E3>g){var w=512/(g+1024),s=320+w*s;d=256+w*d;0<s&&(640>s&&0<d&&512>d)&&(g=(512-g)/1024,0>g?g=0:1<g&&(g=1),A.globalAlpha=g*e,A.fillRect(s,d,2,2))}}c-=15100;if(0<=c&&(e=c/480/8|0,240>(c%480|0)))switch(A.globalAlpha=1,A.textAlign="left",A.textBaseline="top",e){case 0:A.fillStyle="#999999";A.font="40px sans-serif";A.fillText("Anders Tornblad",10,10);A.fillStyle="#666666";A.font="30px sans-serif";A.fillText("JavaScript, 2013",10,55);break;case 1:A.fillStyle="#999999";
A.font="40px sans-serif";A.fillText("Olivi\u00e9r Bechard (RA)",10,10);A.fillStyle="#666666";A.font="30px sans-serif";A.fillText("Graphics, 1993",10,55);break;case 2:A.fillStyle="#999999",A.font="40px sans-serif",A.fillText("Fr\u00e9d\u00e9ric Motte (Moby)",10,10),A.fillStyle="#666666",A.font="30px sans-serif",A.fillText("Music, 1993",10,55)}},function(a,c,d){A.fillStyle="#000000";A.fillRect(0,0,640,512);a=65536*(1.5*B[65536*y(d)&65535]-0.5);c=0.5*y(d)+0.5;for(var e=262144*y(d),l=0.8>d?0.5:0.9>d?
0.5-2.5*(d-0.8):3.75*y(10*(d-0.9))+0.25,f=80*B[e&65535]+50,h=72*B[e+23E3&65535],j=50*B[a&65535]+52,q=bb.data,m=db.data,g=0,s=0;100>s;++s)for(var w=0;100>w;++w){var k=s-50,r=w-50,p=k*B[a+16384&65535]+r*B[a&65535],t=r*B[a+16384&65535]-k*B[a&65535],t=t-f,p=p-h,p=p/c,t=t/c,z=k*B[e+16384&65535]+r*B[e&65535],r=r*B[e+16384&65535]-k*B[e&65535],z=z/l,r=r/l,r=r-j,z=z- -40,k=(w+s-200)/200+2*d;0>k&&(k=0);1<k&&(k=1);t=t*(1-k)+r*k;p=p*(1-k)+z*k;t&=127;p&=127;p=4*(128*p+t);m[g++]=q[p++];m[g++]=q[p++];m[g++]=q[p++];
m[g++]=255}cb.putImageData(db,0,0);A.drawImage(V,120,56,400,400);A.fillStyle="#998888";A.textAlign="center";A.font="italic 50px serif";A.textBaseline="top";A.fillText("learning...",320,0);A.font="italic 25px serif";A.textBaseline="top";A.fillText("...by reinventing the wheel",320,456);0.05>d&&(A.fillStyle="rgba(0,0,0,"+(1-20*d).toFixed(3)+")",A.fillRect(0,0,640,512));0.9<d&&(A.fillStyle="rgba(0,0,0,"+(10*d-9).toFixed(3)+")",A.fillRect(0,0,640,512))},function(a,c,d){A.fillStyle="#000000";A.fillRect(0,
0,640,512);var e=a?hb:gb,l=a?fb:eb;a=a?0:60;var f=320-l.width/2;A.globalAlpha=0.9>d?1:10-10*d;for(d=0;d<e.length;++d){var h=e[d];c>h.a&&A.drawImage(l,h.x,h.y,h.j,h.i,h.x+f,2*h.y+a,h.j,2*h.i)}}],jb=[{a:0,f:4700,g:0,h:0},{a:4700,f:8400,g:0,h:1},{a:8400,f:9500,g:0,h:2},{a:9500,f:4E4,g:2,h:0},{a:4E4,f:44E3,g:5,h:0},{a:44E3,f:48E3,g:5,h:1},{a:48E3,f:52E3,g:3,h:0},{a:52E3,f:56E3,g:3,h:1},{a:56E3,f:63300,g:3,h:2},{a:63300,f:82500,g:4,h:0},{a:82500,f:9E4,g:5,h:2},{a:9E4,f:94E3,g:5,h:3},{a:94E3,f:98E3,g:6,
h:0},{a:98E3,f:128500,g:6,h:1},{a:128500,f:132500,g:1,h:0},{a:132500,f:139500,g:1,h:1},{a:139500,f:147E3,g:1,h:2},{a:147E3,f:163E3,g:1,h:3},{a:163E3,f:178300,g:7,h:0},{a:178300,f:182300,g:8,h:0},{a:182300,f:188E3,g:8,h:1},u];
...
onItemsLoader=function(a){$&&(window.clearTimeout($),$=n);A.fillStyle="#000000";A.fillRect(0,0,640,512);A.fillStyle="#ffffff";a.q==a.total?(A.font="50px sans-serif",A.textAlign="center",A.textBaseline="middle",A.fillText("Loading done!",320,256),A.font="20px sans-serif",A.fillText("Click to start...",320,296),window.setTimeout(onLoadingDone,10),ka.addEventListener("click",onLoadingDone,u)):(A.font="30px sans-serif",A.textAlign="center",A.textBaseline="middle",A.fillText("Loading...",320,256),A.font=
"20px sans-serif",A.fillText((100*(a.q/a.total)).toFixed(0)+" % done",320,296))};onDemoDone=function(){window.location.href="part-2/"};
