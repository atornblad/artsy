var b=!0,l=null,u=!1,aa=Math.random,ba=0,ca=1;function da(a,c,d){return"rgba("+(a|0)+","+(c|0)+","+(d|0)+",1)"}var x;a:{for(var ea=["requestAnimationFrame","mozRequestAnimationFrame","webkitRequestAnimationFrame"],fa=0;fa<ea.length;++fa){var ga=ea[fa];if(window[ga]){x=window[ga];break a}}x=function(a){var c=(new Date).getTime(),c=c-c%17+17-c;5>c&&(c=17);window.setTimeout(function(){a.call(window,(new Date).getTime())},c)}}var ia=4*Math.atan(1),ja=Math.max(320,256);
function y(a){return(1-Math.cos(a*ia))/2}
for(var ka,z,A,la,ma,na,B,oa=0,pa,E,qa,F,G,H,ra=0,sa=0,I=0,ta=10,J=1050,ua=9,va=9,wa=32768,xa=[{p:255,n:255,k:255},{p:255,n:64,k:128},{p:255,n:255,k:255},{p:96,n:240,k:255}],ya,N,O,za,P,Aa,Ba,Da,Ea,Fa,Ga,Q,Ha,Ia,Ja,Ka,La,Ma,Na,Oa,Pa,Qa,R=[],Ra=[{b:31,c:0,d:481,e:0},{b:481,c:0,d:440,e:460},{b:440,c:460,d:256,e:511},{b:256,c:511,d:71,e:460},{b:71,c:460,d:31,e:0},{b:256,c:37,d:440,e:37},{b:440,c:37,d:405,e:431},{b:405,c:431,d:256,e:472},{b:256,c:472,d:256,e:413},{b:256,c:355,d:256,e:264},{b:256,c:208,
...
"bold 120px sans-serif",z.fillText("tricycle",-640,360));break;case 2:z.globalAlpha=0.25<d?4/3-4*(d/3):0.1>d?10*d:1,z.drawImage(F,320-(F.width>>1),256-(F.height>>1))}},function(a,c,d,f){z.fillStyle="#240000";z.fillRect(0,0,640,512);d=320+ja*A[wa];for(var m=256+ja*A[(wa+16384)%65536],e=0==a?800*A[32768*c/4E3&65535]:sa,h=0==a?0:ua,j=0==a?0:va;j>=h;--j){var q=50+100*j+e,k=0==a?1:1-(q-50)/1E3,g=1-(q-J-50)/1E3;1<g&&(g=1);var t=xa[j>=ta?(j+ra)%4:0],s=320*g+d*(1-g),g=256*g+m*(1-g);z.beginPath();for(var n=
0;65536>=n;n+=256){var p=320*(1+0.3*A[10*n%65536]),r=s+100/q*p*A[(n+I)%65536],p=g+100/q*p*A[(n+16384+I)%65536];n?z.lineTo(r,p):z.moveTo(r,p)}for(n=65536;0<=n;n-=4096)p=320,r=s+100/q*p*A[(n+I)%65536],p=g+100/q*p*A[(n+16384+I)%65536],z.lineTo(r,p);z.closePath();z.fillStyle="rgba("+(t.p*k+36*(1-k)).toFixed(0)+","+(t.n*k).toFixed(0)+","+(t.k*k).toFixed(0)+",1)";z.fill()}for(d=sa-9*f;0>d;)++ra,d+=100,2<=a&&0<ta&&--ta,1<=a&&0<ua&&--ua,3==a&&c>16E3-1E3*(1050/9)/60&&--va;sa=d|0;I=I+65536-473*f&65535;3==a&&
(0<J?J-=9*f:(J=0,wa=wa+65536-100*f&65535))},function(a,c,d){a=Ba.data;var f=za.data;z.fillStyle="#350000";z.fillRect(0,0,640,50);z.fillRect(0,462,640,50);z.fillStyle="#46051e";z.fillRect(0,50,640,14);z.fillRect(0,448,640,14);z.fillStyle="#000000";z.fillRect(0,64,640,384);var m=0,e=c-15E3;0>e?e=0:3276.8>e&&(e=3276.8*y(5*(e/16384)));var e=0.25*A[5*e&65535],h=c-5E3;0>h&&(h=0);for(var h=1.5*A[7*h&65535],j=15300-c,j=(0<j?j:c?c/d-c:3E4)/2,q=500>j&&0<j,k=96,g=-96,t,s,n=16500<c?1100-c/2%1600:2E4,p=4;0>n;)--p,
n+=120;d=[];for(var r=-96;96>=r;++r)if(0!=r){var w=(h*Math.abs(r)/96+h)/2,K=r/50,C=r+2*(r-0),v=(288-C)/(K-w),D=0>v;D&&(v=(-288-C)/(K-w));K=D?Ga:Fa;w=(v- -150)/150;if(D&&v>n&&500>v&&(!q||v<j)&&0<p)d.push({u:r,r:-160/w-v*e,t:160/w-v*e,height:100/w,alpha:1-v/500}),n+=120,--p;D=u;if(q&&v>j)r<k&&(k=r),r>g&&(g=r,t=-160/w-j*e,s=160/w-j*e);else if(500>v)var ha=v+c/2,L=256*(1-v/500)&511,M=v*e,v=ha/O/4&255,D=0<=v?K[v]:u,ha=ha%O&255;v=-160/w-M;K=160/w-M;for(C=-160;160>C;++C){if(C<v||C>K||D===u||void 0===D)a[m++]=
a[m++]=a[m++]=0;else{var Ca=4*(ha*N+(((C+M)*w+160>>1)%20&4095)+D);a[m++]=f[Ca++]*L>>8;a[m++]=f[Ca++]*L>>8;a[m++]=f[Ca++]*L>>8}a[m++]=255}}Aa.putImageData(Ba,0,0);z.drawImage(P,0,64,640,384);q&&(z.globalAlpha=1-j/500,z.drawImage(Da,2*t+320,2*k+256,2*(s-t),2*(g-k)));for(t=d.length;c=d[--t];)s=2*c.r+320,L=2*(c.t-c.r),M=2*c.u+256,a=c.height,z.globalAlpha=1,z.fillStyle="#000000",z.fillRect(s,M,L,a),z.globalAlpha=c.alpha,z.drawImage(Ea,s,M,L,a)},function(a,c,d){var f=19*c+1E4;z.fillStyle="#441010";z.fillRect(0,
0,640,512);c=160*A[f&65535];var m=160*A[f+32768&65535],e=A[f+16384&65535],f=-e,h=2/(2-e),j=2/(2-f);c*=h;var m=m*j,q=G.width,k=G.height,g=H.width,t=H.height;switch(a){case 0:z.globalAlpha=0.2>d?5*d:0.8>d?1:5-5*d;a=q*h;d=k*h;z.drawImage(G,320+c-a/2,256-d/2,a,d);break;case 1:z.globalAlpha=0.2>d?5*d:0.8>d?1:5-5*d;a=g*h;d=t*h;0<e&&z.drawImage(G,320-q/2,256-k/2);z.drawImage(H,320+c-a/2,256-d/2,a,d);0>=e&&z.drawImage(G,320-q/2,256-k/2);break;case 2:z.globalAlpha=0.1>d?10*d:0.9>d?1:10-10*d,a=q*h,d=k*h,e=
g*j,j*=t,0<f&&z.drawImage(G,320+c-a/2,256-d/2,a,d),z.drawImage(H,320+m-e/2,256-j/2,e,j),0>=f&&z.drawImage(G,320+c-a/2,256-d/2,a,d)}},function(a,c,d){z.fillStyle="#110000";z.fillRect(0,0,640,512);a=Ka.width;var f=Ka.height;z.drawImage(Ka,320-a,256-f,2*a,2*f);a=Ia.data;for(var f=144*A[23*c&65535]+256-112|0,m=144*A[17*c&65535]+256-112|0,e=0,h=0;223>=h;++h)for(var j=0;223>=j;++j){var q=0;a[e++]=255;a[e++]=255;a[e++]=255;var k=Ja[j];0<k&&(k=((h-112)/k|0)+112,0<=k&&223>=k&&(q=Ma[512*(k+m)+j+f]));a[e++]=
...
f:163E3,g:1,h:3},{a:163E3,f:178300,g:7,h:0},{a:178300,f:182300,g:8,h:0},{a:182300,f:188E3,g:8,h:1},u];
function kb(a){if(na){ca=60*((a-ma)/1E3);ba=a-na;var c=jb[oa];c&&ba>=c.f&&(++oa,c=jb[oa]);if(c){var d=ba-c.a,f=d/(c.f-c.a);pa=ib[c.g];var m=(new Date).getTime();z.globalAlpha=1;z.save();pa.call(this,c.h,d,f,ca);z.restore()}else E=u;c=(22-((new Date).getTime()-m)-10*ca)/200;0<c&&(c*=0.005);c=la+c;1<c?c=1:0.1>c&&(c=0.1);la=c}B&&(1>B&&(na=a-1E3*B-250),ma=a);E?x(kb):(a=document.createEvent("Event"),a.initEvent("demoDone",b,b),window.dispatchEvent(a))}function lb(){E=b;x(kb)}
function mb(){B=this.currentTime}var W=[],X=0;function nb(a){W.push(a);++X;a=document.createEvent("Event");a.initEvent("itemsLoader",b,b);a.total=X;a.q=X-W.length;window.dispatchEvent(a)}function ob(a){for(var c=[],d=0;d<W.length;++d)W[d]!=a&&c.push(W[d]);W=c;a=document.createEvent("Event");a.initEvent("itemsLoader",b,b);a.total=X;a.q=X-W.length;window.dispatchEvent(a)}var Y=l;
function pb(){Y&&window.clearTimeout(Y);var a=this;Y=window.setTimeout(function(){Y=l;a.removeEventListener("progress",pb,u);ob(a)},2E3)}function qb(){Y&&(window.clearTimeout(Y),Y=l);this.removeEventListener("progress",pb,u);ob(this)}function rb(){ob(this)}function Z(a){var c=new Image;nb(c);c.addEventListener("load",rb,u);c.src=a+"?ts="+(new Date).getTime();return c}var $=l;
