...
c&&(z.font="bold 100px sans-serif",z.fillText("NOSTRADAMUS",-640,360));break;case 1:a=3300<=c?(3700-c)/400:1;z.fillStyle=ba(153*a,136*a,136*a);z.font="50px sans-serif";z.fillText("SO",-736,40);800<=c&&(z.font="50px sans-serif",z.fillText("JUST",-576,40));1100<=c&&(z.fillStyle=ba(187*a,170*a,170*a),z.font="bold 100px sans-serif",z.fillText("Straight",-640,120));2E3<=c&&(z.font="50px sans-serif",z.fillText("OFF",-640,260));2650<=c&&(z.font="50px sans-serif",z.fillText("THE",-640,310));2950<=c&&(z.font=
"bold 120px sans-serif",z.fillText("tricycle",-640,360));break;case 2:z.globalAlpha=0.25<d?4/3-4*(d/3):0.1>d?10*d:1,z.drawImage(B,320-(B.width>>1),256-(B.height>>1))}},function(a,c,d,f){z.fillStyle="#240000";z.fillRect(0,0,640,512);d=320+ga*A[G];for(var k=256+ga*A[(G+16384)%65536],e=0==a?800*A[32768*c/4E3&65535]:ra,h=0==a?0:ta,j=0==a?0:ua;j>=h;--j){var n=50+100*j+e,l=0==a?1:1-(n-50)/1E3,g=1-(n-F-50)/1E3;1<g&&(g=1);var r=va[j>=sa?(j+qa)%4:0],t=320*g+d*(1-g),g=256*g+k*(1-g);z.beginPath();for(var q=
0;65536>=q;q+=256){var p=320*(1+0.3*A[10*q%65536]),s=t+100/n*p*A[(q+E)%65536],p=g+100/n*p*A[(q+16384+E)%65536];q?z.lineTo(s,p):z.moveTo(s,p)}for(q=65536;0<=q;q-=4096)p=320,s=t+100/n*p*A[(q+E)%65536],p=g+100/n*p*A[(q+16384+E)%65536],z.lineTo(s,p);z.closePath();z.fillStyle="rgba("+(r.p*l+36*(1-l)).toFixed(0)+","+(r.n*l).toFixed(0)+","+(r.k*l).toFixed(0)+",1)";z.fill()}for(d=ra-9*f;0>d;)++qa,d+=100,2<=a&&0<sa&&--sa,1<=a&&0<ta&&--ta,3==a&&c>16E3-1E3*(1050/9)/60&&--ua;ra=d|0;E=E+65536-473*f&65535;3==a&&
(0<F?F-=9*f:(F=0,G=G+65536-100*f&65535))},function(a,c){var d=ya.data,f=wa.data;z.fillStyle="#350000";z.fillRect(0,0,640,50);z.fillRect(0,462,640,50);z.fillStyle="#46051e";z.fillRect(0,50,640,14);z.fillRect(0,448,640,14);z.fillStyle="#000000";z.fillRect(0,64,640,384);var k=0,e=244480,h,j=0;4E3>c?h=0:1E4>c?(h=0.2,j=(6E3-c)/4):12E3>c?(h=(12E3-c)/1E4,j=0):18E3>c?(h=-0.2,j=(14E3-c)/4):2E4>c?(h=(c-2E4)/1E4,j=0):26E3>c?(h=0.2,j=(22E3-c)/4):28E3>c?(h=(28E3-c)/1E4,j=0):h=0;0>j&&(j=0);for(var n=0;64>n;++n){var l=
64/(64-n),g=n*l;if(500>g)var r=g+c/4,t=255/l,q=g>j?(g-j)*h:0,g=r/J/4&255,g=0<=g?L[g]:u,r=r%J&255;else g=u;for(var p=-160;160>p;++p){var s=(p+q)*l;-160>s||160<s||g===u||void 0===g?(d[k++]=d[k++]=d[k++]=0,d[k++]=255,d[e++]=d[e++]=d[e++]=0,d[e++]=255):(s=4*(r*I+((s+160>>1)%20&4095)+g),d[k++]=d[e++]=f[s++],d[k++]=d[e++]=f[s++],d[k++]=d[e++]=f[s++],d[k++]=d[e++]=t)}e-=2560}xa.putImageData(ya,0,0);z.drawImage(K,0,64,640,384);z.fillStyle="#998888";z.font="30px sans-serif";z.textAlign="center";z.textBaseline=
"center";z.fillText("To do: Finish bitmap tunnel effect",320,256)},function(a,c,d){var f=19*c+1E4;z.fillStyle="#441010";z.fillRect(0,0,640,512);c=160*A[f&65535];var k=160*A[f+32768&65535],e=A[f+16384&65535],f=-e,h=2/(2-e),j=2/(2-f);c*=h;var k=k*j,n=C.width,l=C.height,g=D.width,r=D.height;switch(a){case 0:z.globalAlpha=0.2>d?5*d:0.8>d?1:5-5*d;a=n*h;d=l*h;z.drawImage(C,320+c-a/2,256-d/2,a,d);break;case 1:z.globalAlpha=0.2>d?5*d:0.8>d?1:5-5*d;a=g*h;d=r*h;0<e&&z.drawImage(C,320-n/2,256-l/2);z.drawImage(D,
320+c-a/2,256-d/2,a,d);0>=e&&z.drawImage(C,320-n/2,256-l/2);break;case 2:z.globalAlpha=0.1>d?10*d:0.9>d?1:10-10*d,a=n*h,d=l*h,e=g*j,j*=r,0<f&&z.drawImage(C,320+c-a/2,256-d/2,a,d),z.drawImage(D,320+k-e/2,256-j/2,e,j),0>=f&&z.drawImage(C,320+c-a/2,256-d/2,a,d)}},function(a,c,d){z.fillStyle="#110000";z.fillRect(0,0,640,512);a=O.width;var f=O.height;z.drawImage(O,320-a,256-f,2*a,2*f);a=za.data;for(var f=144*A[23*c&65535]+256-112|0,k=144*A[17*c&65535]+256-112|0,e=0,h=0;223>=h;++h)for(var j=0;223>=j;++j){var n=
0;a[e++]=255;a[e++]=255;a[e++]=255;var l=Aa[j];0<l&&(l=((h-112)/l|0)+112,0<=l&&223>=l&&(n=Ca[512*(l+k)+j+f]));a[e++]=n}N.clearRect(0,0,224,224);N.putImageData(za,0,0);z.drawImage(M,96,32,448,448);512>c&&(z.fillStyle="#441000",z.fillRect(0,0,640,256-c/2),z.fillRect(0,256+c/2,640,256-c/2));0.95<d&&(z.fillStyle="rgba(0,0,0,"+(20*d-19).toFixed(3)+")",z.fillRect(0,0,640,512))},function(a,c,d){z.fillStyle="#000000";z.fillRect(0,0,640,512);a=Q[a];var f=a.o,k=f.width*a.scale,e=f.height*a.scale;z.drawImage(f,
320-(k>>1),256-(e>>1),k,e);500>c?(z.globalAlpha=1-c/500,z.fillStyle=a.l,z.fillRect(0,0,640,512)):(c=c/d-c,500>c&&(z.globalAlpha=1-c/500,z.fillStyle=a.m,z.fillRect(0,0,640,512)))},function(a,c,d){var f=1;0.95<d&&(f=20*(1-d));z.fillStyle="#000000";z.fillRect(0,0,640,512);var k,e,h,j,n,l;switch(a){case 0:k=Ia;e=h=j=0;n=1024-2048*d;l=c/4;break;case 1:k=Na,n=0,l=c/4,e=0,6E3<c?e=1:2E3<c&&(e=y((c-2E3)/4E3)),j=-c/10+2048*e*A[5*c+3E4&65535],h=1024*e*A[2*c+54E3&65535],e=18E3<c?1:14E3<c?y((c-14E3)/4E3):0,e=
3072*e*A[3*(c-14E3)&65535]}l>k.length&&(l=k.length);z.fillStyle="#ffffff";for(a=0;a<l;++a){var g=k[a],r=Pa(g.x+e);d=Pa(g.y+h);g=Pa(g.r+j);g+=n;if(-1E3<g&&1E3>g){var t=512/(g+1024),r=320+t*r;d=256+t*d;0<r&&(640>r&&0<d&&512>d)&&(z.globalAlpha=(1E3-g)/2E3*f,z.fillRect(r,d,2,2))}}c-=15100;if(0<=c&&(f=c/480/8|0,240>(c%480|0)))switch(z.globalAlpha=1,z.textAlign="left",z.textBaseline="top",f){case 0:z.fillStyle="#999999";z.font="40px sans-serif";z.fillText("Anders Tornblad",10,10);z.fillStyle="#666666";
z.font="30px sans-serif";z.fillText("JavaScript, 2013",10,55);break;case 1:z.fillStyle="#999999";z.font="40px sans-serif";z.fillText("Olivi\u00e9r Bechard (RA)",10,10);z.fillStyle="#666666";z.font="30px sans-serif";z.fillText("Graphics, 1993",10,55);break;case 2:z.fillStyle="#999999",z.font="40px sans-serif",z.fillText("Fr\u00e9d\u00e9ric Motte (Moby)",10,10),z.fillStyle="#666666",z.font="30px sans-serif",z.fillText("Music, 1993",10,55)}},function(a,c,d){z.fillStyle="#000000";z.fillRect(0,0,640,512);
a=65536*A[65536*y(d)&65535];c=196608*y(d);for(var f=0.8>d?0.5:0.9>d?0.5-2.5*(d-0.8):3.75*y(10*(d-0.9))+0.25,k=80*A[c&65535]+50,e=72*A[c+23E3&65535],h=50*A[a&65535]+52,j=Ra.data,n=Ta.data,l=0,g=0;100>g;++g)for(var r=0;100>r;++r){var t=g-50,q=r-50,p=t*A[a+16384&65535]+q*A[a&65535],s=q*A[a+16384&65535]-t*A[a&65535],s=s-k,p=p-e,p=p/1,s=s/1,P=t*A[c+16384&65535]+q*A[c&65535],q=q*A[c+16384&65535]-t*A[c&65535],P=P/f,q=q/f,q=q-h,P=P- -40,t=(r+g-200)/200+2*d;0>t&&(t=0);1<t&&(t=1);s=s*(1-t)+q*t;p=p*(1-t)+P*
t;s&=127;p&=127;p=4*(128*p+s);n[l++]=j[p++];n[l++]=j[p++];n[l++]=j[p++];n[l++]=255}Sa.putImageData(Ta,0,0);z.drawImage(V,120,56,400,400);z.fillStyle="#998888";z.textAlign="center";z.font="italic 40px serif";z.textBaseline="top";z.fillText("a glimpse from 1974",320,0);0.05>d&&(z.fillStyle="rgba(0,0,0,"+(1-20*d).toFixed(3)+")",z.fillRect(0,0,640,512));0.9<d&&(z.fillStyle="rgba(0,0,0,"+(10*d-9).toFixed(3)+")",z.fillRect(0,0,640,512))},function(a,c,d){z.fillStyle="#000000";z.fillRect(0,0,640,512);var f=
a?Xa:Wa,k=a?Va:Ua;a=a?0:60;var e=320-k.width/2;z.globalAlpha=0.9>d?1:10-10*d;for(d=0;d<f.length;++d){var h=f[d];c>h.a&&z.drawImage(k,h.x,h.y,h.j,h.i,h.x+e,2*h.y+a,h.j,2*h.i)}},function(a,c,d){z.fillStyle="#000073";z.fillRect(0,0,640,512);100<c&&(a=c/d-c,z.fillStyle="#ffffff",z.font="30px sans-serif",z.textAlign="center",z.textBaseline="middle",z.fillText("This scene is not yet implemented...",320,256),z.font="20px sans-serif",z.fillText((a/1E3).toFixed(1)+" seconds to next implemented scene",320,
296))}],Za=[{a:0,f:4700,g:0,h:0},{a:4700,f:8400,g:0,h:1},{a:8400,f:9500,g:0,h:2},{a:9500,f:4E4,g:2,h:0},{a:4E4,f:44E3,g:5,h:0},{a:44E3,f:48E3,g:5,h:1},{a:48E3,f:52E3,g:3,h:0},{a:52E3,f:56E3,g:3,h:1},{a:56E3,f:63300,g:3,h:2},{a:63300,f:82500,g:4,h:0},{a:82500,f:9E4,g:5,h:2},{a:9E4,f:94E3,g:5,h:3},{a:94E3,f:98E3,g:6,h:0},{a:98E3,f:128500,g:6,h:1},{a:128500,f:132500,g:1,h:0},{a:132500,f:139500,g:1,h:1},{a:139500,f:147E3,g:1,h:2},{a:147E3,f:163E3,g:1,h:3},{a:163E3,f:178300,g:7,h:0},{a:178300,f:182300,
g:8,h:0},{a:182300,f:188E3,g:8,h:1},u];function $a(a){if(ka){aa=60*((a-ja)/1E3);w=a-ka;var c=Za[ma];c&&w>=c.f&&(++ma,c=Za[ma]);if(c){var d=w-c.a,f=d/(c.f-c.a);na=Ya[c.g];var k=(new Date).getTime();z.globalAlpha=1;z.save();na.call(this,c.h,d,f,aa);z.restore()}c=(22-((new Date).getTime()-k)-10*aa)/200;0<c&&(c*=0.005);c=ia+c;1<c?c=1:0.1>c&&(c=0.1);ia=c}la&&(ja||(ka=a-1E3*la),ja=a);oa&&x($a)}function ab(){oa=b;x($a)}function bb(){la=this.currentTime}var W=[],X=0;
...
f;++f)for(a=0;512>a;++a)Ca[d]=128<c[4*d]?112:0,++d;Q.push({l:"#ffffff",m:"#000000",o:Da,scale:2});Q.push({l:"#000000",m:"#441010",o:Ea,scale:2});Q.push({l:"#ffffff",m:"#000000",o:Fa,scale:2});Q.push({l:"#000000",m:"#000000",o:Ga,scale:2});I=H.width;J=H.height;a=document.createElement("CANVAS");a.width=I;a.height=J;a=a.getContext("2d");a.drawImage(H,0,0,I,J);wa=a.getImageData(0,0,I,J);K=document.createElement("CANVAS");K.width=320;K.height=192;xa=K.getContext("2d");ya=xa.createImageData(320,192);L=
[];for(a=0;77>a;++a)c="    aaa bbb ccaaddddbbbbaaaacccc aaabbbdddbbbccc aa bbddddccccddbbbbabbbbcccc"[a]," "==c?L.push(u):L.push(20*(c.charCodeAt(0)-97));a=document.createElement("CANVAS");a.width=a.height=128;a=a.getContext("2d");a.drawImage(Qa,0,0);Ra=a.getImageData(0,0,128,128);V=document.createElement("CANVAS");V.width=100;V.height=100;Sa=V.getContext("2d");Ta=Sa.createImageData(100,100);pa.play()};
